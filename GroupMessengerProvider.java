...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        Log.v("insert", "Debugging Key, Value"+key+" "+val);
        ...
        try {
            ...
            Log.v("insert", "File write failed "+e);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        try {
            inputStream =  currentContext.openFileInput(selection);
            ...
            Log.v("Query", "File open failed "+e);
        }


        Log.v("Query", "Key and value "+selection+" "+value);
